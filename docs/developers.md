...
2. A page describing the release at `pyscript.net/releases/<CALVER>`. For
   example: [https://pyscript.net/releases/2026.7.2/](https://pyscript.net/releases/2026.7.2/).
...
[https://pyscript.net/releases/2026.7.2/](https://pyscript.net/releases/2026.7.2/))
...
> https://pyscript.net/releases/2026.7.2/ As always, feedback welcome. 🎉
