...
```js
import { hooks } from "https://pyscript.net/releases/2024.10.22/core.js";
...
<html lang="en">
    <head>
        ...
        <!-- PyScript -->
        <link rel="stylesheet" href="https://pyscript.net/releases/2024.10.22/core.css">
        <script type="module" src="https://pyscript.net/releases/2024.10.22/core.js"></script>
    </head>
    <body>
        <script type="mpy">
            print("ACTUAL CODE")
